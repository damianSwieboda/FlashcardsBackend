...
6. [Features](#features)
7. [Sets and Cards logic](#features)
8. [Translations of cards logic](#translation-of-cards-logic)
9. [Adding sets and cards to learning stack](#adding-sets-and-cards-to-learning-stack)
...
"Every card contains a 'translations' property, which comprises an array of objects. Each object represents a language translation of the card in which it is located. There is no single main expression to translate; instead, multiple translations are grouped by meaning and common definitions.
